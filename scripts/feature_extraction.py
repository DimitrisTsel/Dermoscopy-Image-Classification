...
def extract_f(image,mask=None): 
    ...
    features =  mean_R, std_R, skew_R, kurt_R, mean_G,  std_G,  skew_G, kurt_G, mean_B,  std_B,  skew_B, kurt_B, mean_H, std_H, skew_H, kurt_H, mean_S,  std_S,  skew_S, kurt_S, mean_V,  std_V,  skew_V, kurt_V,  mean_L, std_L, skew_L, kurt_L, mean_A,  std_A,  skew_A, kurt_A, mean_b,  std_b,  skew_b, kurt_b,  mean_Y, std_Y, skew_Y, kurt_Y, mean_Cr, std_Cr, skew_Cr,kurt_Cr, mean_Cb, std_Cb, skew_Cb, kurt_Cb,mean_l, std_l, skew_l,kurt_l, mean_u,  std_u,  skew_u, kurt_u, mean_v,  std_v,  skew_v,  kurt_v, mean_ccR, std_ccR, skew_ccR, kurt_ccR, mean_ccG,  std_ccG,  skew_ccG, kurt_ccG, mean_ccB,  std_ccB,  skew_ccB, kurt_B,mean_ccH, std_ccH, skew_ccH, kurt_ccH, mean_ccS,  std_ccS,  skew_ccS, kurt_ccS, mean_ccV,  std_ccV,  skew_ccV, kurt_ccV,mean_ccL, std_ccL, skew_ccL, kurt_ccL, mean_ccA,  std_ccA,  skew_ccA, kurt_ccA, mean_ccb,  std_ccb,  skew_ccb, kurt_ccb,mean_ccY, std_ccY, skew_ccY,kurt_ccY, mean_ccCr, std_ccCr, skew_ccCr, kurt_ccCr, mean_ccCb, std_ccCb, skew_ccCb, kurt_ccCb,mean_ccl, std_ccl, skew_ccl,kurt_ccl, mean_ccu,  std_ccu,  skew_ccu, kurt_ccu, mean_ccv,  std_ccv,  skew_ccv, kurt_ccv,mean_mxR, std_mxR, skew_mxR, kurt_mxR, mean_mxG,  std_mxG,  skew_mxG, kurt_mxG,  mean_mxB,  std_mxB,  skew_mxB, kurt_mxB,mean_mxH, std_mxH, skew_mxH, kurt_mxH, mean_mxS,  std_mxS,  skew_mxS, kurt_mxS, mean_mxV,  std_mxV,  skew_mxV, kurt_mxV,mean_mxL, std_mxL, skew_mxL, kurt_mxL, mean_mxA,  std_mxA,  skew_mxA, kurt_mxA, mean_mxb,  std_mxb,  skew_mxb, kurt_mxb,mean_mxY, std_mxY, skew_mxY, kurt_mxY, mean_mxCr, std_mxCr, skew_mxCr, kurt_mxCr, mean_mxCb, std_mxCb, skew_mxCb, kurt_mxCb
    return features
